...
function openPopup(assignment) {
  ...
  <head>
    <style>
      * {font-family: Arial}
      @font-face {
            font-family: Xulu;
            src: url(https://filebin.net/4377b2ovq5i9ldc4/FFF_Tusj.ttf);
        }
        @font-face {
            font-family: Spotify;
            src: url(https://filebin.net/4377b2ovq5i9ldc4/Gotham-Black.otf);
        }
        input {
            cursor: pointer;
            border-style: none;
  ...
  <body style="background-image: linear-gradient(to bottom right, black, purple); color:#ff00ff">
  <div style="background-image:url(&quot;https://media0.giphy.com/headers/jmckeehen/s2wy7iphPP98.gif&quot;);"><center style="font-size:50px;position:relative;top:0%;color:#990099;font-weight:900;font-family:Xulu;">Xulu</center></div>
  ...
  <div id="header_div">
    ...
    <div id="title_div">
      ...
      <input id="answers_button" type="button" value="Answer Questions" onclick="answer_questions();" style="width:200px" disabled/>
  ...
  <hr>
  <div style="height:20px"></div>
  <center style="font-size: 25px;">Xulu by Xynfinity</center><div style="height:20px"></div>
  </body>`;
